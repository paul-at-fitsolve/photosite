...
<!--[if (gte IE 9)|(gt IEMobile 7)]><!--><html <?php print $html_attributes . $rdf_namespaces; ?>><!--<![endif]-->
    ...
    <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# og_urgallery: http://ogp.me/ns/fb/og_urgallery#" profile="<?php print $grddl_profile; ?>">
    ...
    <body class="<?php print $classes; ?>" <?php print $attributes; ?>>
        ...
        <script>
            window.fbAsyncInit = function() {
                // init the FB JS SDK
                FB.init({
                    appId      : '319010111536779', // App ID from the App Dashboard
                    channelUrl : 'http://www.ursularodgers.co.uk/channel.html', // Channel File for x-domain communication
